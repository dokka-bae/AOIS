...
print(get_postfix(expr))
truth_table = get_truth_table(get_postfix(expr))
dex_sknf, dex_sdnf = get_dex_form(truth_table)
for row in truth_table:
    print(row)
print("SKNF: ", "".join(get_sknf(truth_table, variables)))
print("SDNF: ", "".join(get_sdnf(truth_table, variables)))
print("DEX SKNF: ", dex_sknf)
print("DEX SDNF: ", dex_sdnf)
print("INDEX: ", get_index_form(truth_table))
